...
?>
<div class="container">
<h2>Visitas a Confirmar</h2>
<h4>Emitido <?php echo $mytime->toDateTimeString();?></h4>
<div class="table-responsive">
<table class="table">
	<thead>
		<tr class="bg-primary"><th>Fecha Programada</th><th>Efector</th><th>Domicilio</th><th>Descripción</th><th>Rubro</th><th>Acudirá</th></tr>
	</thead>
	<tbody>	
<?php
...
foreach($pedidos as $item){
 ...
 echo "<tr><td>".ffec($item->fecha_programada)."</td><td>".$item->efector."</td><td>".$item->domicilio."</td><td>".$item->descripcion." ".$item->comentarios."</td><td>".$drubro."</td><td>".$item->agentes."</td></tr>";
